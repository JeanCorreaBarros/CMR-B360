...
export function Sidebar() {
  ...
  // Definir los iconos del sidebar según el módulo activo
  const sidebarIcons = {
    dashboard: [
      { icon: <HomeIcon />, path: "/" },
    ...
    agenda: [
      { icon: <HomeIcon />, path: "/" },
      { icon: <CalendarIcon />, path: "/agenda", active: true },
    ...
    reportes: [
      { icon: <HomeIcon />, path: "/" },
      { icon: <BarChartIcon />, path: "/reportes", active: true },
    ...
    contabilidad: [
      { icon: <HomeIcon />, path: "/" },
      { icon: <DollarSignIcon />, path: "/contabilidad", active: true },
    ...
    nomina: [
      { icon: <HomeIcon />, path: "/" },
      { icon: <UsersIcon />, path: "/nomina", active: true },
    ...
    marketing: [
      { icon: <HomeIcon />, path: "/" },
      { icon: <TrendingUpIcon />, path: "/marketing", active: true },
    ...
    seguridad: [
      { icon: <HomeIcon />, path: "/" },
      { icon: <ShieldIcon />, path: "/seguridad", active: true },
    ...
    login: [
      { icon: <HomeIcon />, path: "/" },
      { icon: <LockIcon />, path: "/login", active: true },
      { icon: <HelpCircleIcon />, path: "/ayuda" },
    ],
  }
