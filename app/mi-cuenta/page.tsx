                    ...
                    <div className="flex-1 space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          ...
                          <Input id="nombre" defaultValue="Usuario" />
                        </div>
                        <div className="space-y-2">
                          <Label htmlFor="apellido">Apellido</Label>
                          <Input id="apellido" defaultValue="Ejemplo" />
                        </div>
                      </div>
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        defaultValue="Profesional del sector de belleza con más de 5 años de experiencia en gestión de salones."
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input id="ubicacion" defaultValue="Bogotá, Colombia" />
                      </div>
                    </div>
                  </div>
