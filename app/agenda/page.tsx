...
import {
  ...
  GearIcon, // Ícono similar a SettingsIcon
  EnvelopeClosedIcon, // Alternativa a PhoneIcon para comunicación
                    ...
                    {citas
                      ...
                      .map((cita) => {
                        ...
                        return (
                          <div
                            key={cita.id}
                            className="absolute rounded-lg p-2 text-sm cursor-pointer transition-all hover:opacity-90"
                            style={{
                              top: `${top}px`,
                              height: `${height}px`,
                              left: "0",
